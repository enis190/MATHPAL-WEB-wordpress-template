<div id="div_menu_xs" class="container menu-xs" style="z-index: 9999999; ">
    <div class="container">
        <div class="row ">
            ...
            $menu = wp_get_nav_menu_object($locations['header-menu-1']);
            ...
            function is_menu_item_active3($item, $menu_items_by_parent, $post_id)
            {
                ...
                if (!empty($menu_items_by_parent[$item->ID])) {
                    foreach ($menu_items_by_parent[$item->ID] as $child) {
                        if (is_menu_item_active3($child, $menu_items_by_parent, $post_id)) {
                            return true;
                        }
                    }
                }
            ...
            function render_menu_items3($parent_id, $menu_items_by_parent, $post_id)
            {
                ...
                foreach ($menu_items_by_parent[$parent_id] as $item) {
                    ...
                    $is_active = is_menu_item_active3($item, $menu_items_by_parent, $post_id);
                    ...
                    if ($has_children) {
                        render_menu_items3($item->ID, $menu_items_by_parent, $post_id);
                    }
            ...
            <?php render_menu_items3(0, $menu_items_by_parent, $post->ID); ?>
