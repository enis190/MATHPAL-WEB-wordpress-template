...
<section class="slider responsive9 fade-in-top">
                    <div class="item active">
                        <div class="c-block">
                            ...
                            <a href="<?php echo get_permalink(71) ?>" class="btn-1 mt-4">Select <i class="fa-solid fa-circle-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="c-block">
                            ...
                            <p class="mt-4 mb-4">Need a last-minute boost? Our certified tutors deliver expert tips,  tricks, focused lessons, and practice to maximize your score fast.</p>
                            <h4 class="det mt-3 mb-3">Valid for 3 months</h4>
                            ...
                            <a href="<?php echo get_permalink(73) ?>" class="btn-1 mt-4">Select <i class="fa-solid fa-circle-arrow-right"></i></a>
                        </div>
                    </div>
