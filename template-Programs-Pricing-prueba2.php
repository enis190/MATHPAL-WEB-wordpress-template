    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center fade-in">
                <h3><i class="fa-solid fa-tag"></i> 20%* OFF New Premium SAT/ACT Prep Plan <span> | Apply our code at checkout:</span> <span class="code" id="btn_code_copy"><a><i class="fa-solid fa-copy"></i></a> CODE: PREMIUM20</span></h3>
            </div>
        </div>
    </div>
</div> -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center fade-in">
                ...
                <p><b>New! Summer at MathPal:</b> Summer is your window to help your child catch up, stay sharp, or get ahead in math — before school starts again.</p>
            </div>
        </div>
...
<div class="precio1">
    <div class="row justify-content-center">
        <!-- <div class="col-md-4 txt-launch"><div class="launch-special">Launch<br>Special</div> -->
        </div>
        <div class="col-12 text-center px-0">
            	<div class="price-stack text-center">
		<h4 class="precio">120</h4>
		<!-- <span class="precio-anterior">$670</span> -->
	</div>
        </div>
    </div>
	<!-- Launch special (izquierda del precio) -->
...
<ul class="fa-ul mb-4">
                        ...
                        <li><span class="fa-li"><i class="fa-solid fa-calendar color-verde"></i></span>No commitment </li>
                    </ul>

                    <h3>
                        <span>+1 free bonus hour* <br> Limited time  - June & July 2026</span> <br>
                    </h3>


<a href="<?php echo get_permalink(558) ?>" class="btn-1 bg-verde color-negro c-hover-2">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <!-- <div class="col-md-6 text-center text-md-start">
                <h1 class="titulo-h2 fade-in" style="color:#fff;">Math Tutoring Plans & Pricing</h1>
                <h2 class="titulo-h2 fade-in">Flexible tutoring plans that fit your goals</h2>
                <p class="fade-in-top">
                    Choose the best match—Flexible hours per month, cancel or upgrade anytime.
                </p>
            </div> -->
...
<div class="container-fluid suscripcion-1 g-0 bg-3" id="block_emergency_act">
    <div class="container c-slider-3">
        <div class="row bloques-title bloques-title-3">
            <div class="col-12 text-center ">
                <h2 class="titulo-h2 fade-in">Summer tutoring plans:</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?php
                include(TEMPLATEPATH . '/template-parts/programan-summer-at-mathpal.php');
                ?>
            </div>
        </div>
