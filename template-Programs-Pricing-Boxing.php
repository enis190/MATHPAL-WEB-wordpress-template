<?php
/*
 * Template Name: Programs & Pricing Boxing
 */
?>
<?php
get_header();
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center ">
                <h1 fade-in>Math Tutoring Programs</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center fade-in">
                <h3><i class="fa-solid fa-tag"></i> Enjoy 35%* OFF on your first order! <span> | Apply our monthly coupon code at checkout:</span> <span class="code" id="btn_code_copy"><a><i class="fa-solid fa-copy"></i></a> CODE: DEAL35</span></h3>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center fade-in">
                ...
                <p class="subtitle">Dec 26 Only. <strong>Post-holiday deal!</strong></p>
            </div>
        </div>
        <div class="row mt-4 fade-in">
            <div class="col-md-6 img">
                <img src="<?php echo bloginfo('template_url') . '/' ?>assets/img/boxing-day-descuento.png" alt="" class="img-fluid">
            </div>
            <div class="col-md-5 txt">
                <div class="c-block">
                    <h3><span>Enjoy a special</span> <span class="t_bigguer_black">24-hour offer</span>on our math tutoring plans</h3>
                    
                    <!--<div class="precio">69</div>-->
                    <div class="precio_img">
                        <img src="<?php echo bloginfo('template_url') . '/' ?>assets/img/discont.png" alt="" class="img-fluid">
                    </div>

                    <span>
                        <strong>Enjoy this amazing saving on these tutoring plans:</strong>
                    </span> <br><br>

                    <ul class="fa-ul">
                        <li><span class="fa-li"><i class="fa-solid fa-clock"></i></span> <strong>ACT/SAT Prep Courses</strong></li>
                        <li><span class="fa-li"><i class="fa-solid fa-clock"></i></span> <strong>State Exam Prep Courses</strong></li>
                        <li><span class="fa-li"><i class="fa-solid fa-clock"></i></span> <strong>Monthly Subscription Plans: 2, 4, 6, or 8 hours</strong></li>
                        
                        
                        
                    </ul>

                    <a href="<?php echo get_permalink(26) ?>" class="btn-1 bg-verde color-negro c-hover-2">Choose your plan &nbsp;<i class="fa-solid fa-circle-arrow-right ani_fa_balanceo"></i></a>
