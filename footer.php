...
<div class="container-fluid c-footer">
    <div class="container">
        ...
        <div class="row">
            ...
            <source src="<?php echo bloginfo('template_url') . '/' ?>assets/img/logo_footer.mp4" type="video/mp4">
            ...
            <div class="col-md-9 offset-md-1">
                <div class="row">
                    ...
                    <div class="col-md-3 c-group-2 mt-4 mt-sm-0">
                        ...
                        <p><a href="https://wa.link/e0yi3z" target="_blank"><i class="fa-brands fa-whatsapp"></i> +1 (954) 850 9496</a></p>
...
<script src="<?php echo bloginfo('template_url') . '/' ?>assets/js/cmln.js?v=2.1"></script>
